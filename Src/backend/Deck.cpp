#include "Deck.h"
    ...
    Card question4("Science Challenge", "Which of the following is a compound?", {"O₂", "H₂O", "Au", "Al"}, 3);
    ...
    Card question7("Science Challenge", "Who is the founder of quantum mechanics theory?", {"Albert Einstein", "Galileo Galilei", "Erwin Schrödinger", "Isaac Newton"}, 2);
